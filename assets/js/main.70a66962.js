!(function (t) {
  ...
  JkW7: function (t, e, n) {
    ...
    !(function (t) {
      ...
      Object.assign(window, { type: o.c, navActivePage: o.b, movingBackgroundImage: o.a });
  },
  "Lu+Q": function (t, e, n) {
    (function (t) {
      +(function (t) {
  ...
  aWFY: function (t, e, n) {
    ...
    (function (t) {
      function i(t) {
        new s.a("#typed", { stringsElement: "#typed-strings", typeSpeed: 100, backSpeed: 20, loop: !0, loopCount: 1 / 0 });
      }
      function o() {
    ...
    !(function (e, n) {
      ...
      function w(t, e) {
        for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
          (i = t[r]),
            i.style &&
              ((n = i.style.display),
              e ? ("none" === n && ((o[r] = Ht.get(i, "display") || null), o[r] || (i.style.display = "")), "" === i.style.display && zt(i) && (o[r] = x(i))) : "none" !== n && ((o[r] = "none"), Ht.set(i, "display", n)));
      ...
      function k(t, e, n, i, o) {
        ...
        for (p.textContent = "", d = 0; (r = f[d++]); )
          ...
          else if (((u = yt.contains(r.ownerDocument, r)), (s = T(p.appendChild(r), "script")), u && C(s), n)) for (c = 0; (r = s[c++]); ) Gt.test(r.type || "") && n.push(r);
        return p;
      }
      function E() {
        return !0;
      ...
      function q(t, e, n) {
        ...
        return (
          ...
          n &&
            ...
            !vt.pixelMarginRight() && ue.test(s) && le.test(e) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r))),
          void 0 !== s ? s + "" : s
        );
      }
      function R(t, e) {
      ...
      function B(t, e, n, i, o) {
        ...
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
          "margin" === n && (s += yt.css(t, n + Ut[r], !0, o)),
            i
              ? ("content" === n && (s -= yt.css(t, "padding" + Ut[r], !0, o)), "margin" !== n && (s -= yt.css(t, "border" + Ut[r] + "Width", !0, o)))
              : ((s += yt.css(t, "padding" + Ut[r], !0, o)), "padding" !== n && (s += yt.css(t, "border" + Ut[r] + "Width", !0, o)));
        return s;
      }
      function W(t, e, n) {
        var i,
        ...
        return ue.test(r)
          ? r
          : ((i = s && (vt.boxSizingReliable() || r === t.style[e])), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + B(t, e, n || (s ? "border" : "content"), i, o) + "px");
      }
      ...
      function X(t, e, n) {
        ...
        if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(d)) {
          p &&
            ...
            (c = yt.css(t, "display")),
            "none" === c && (u ? (c = u) : (w([t], !0), (u = t.style.display || u), (c = yt.css(t, "display")), w([t]))),
          ...
          for (i in d)
            l ||
              (m ? "hidden" in m && (g = m.hidden) : (m = Ht.access(t, "fxshow", { display: u })),
              r && (m.hidden = !g),
              g && w([t], !0),
              f.done(function () {
              ...
              if (null != (t = arguments[a]))
                for (e in t)
                  (n = s[e]),
                    (i = t[e]),
                    s !== i &&
                      (u && i && (yt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? ((o = !1), (r = n && Array.isArray(n) ? n : [])) : (r = n && yt.isPlainObject(n) ? n : {}), (s[e] = yt.extend(u, r, i))) : void 0 !== i && (s[e] = i));
            return s;
          }),
        yt.extend({
              ...
              preFilter: {
                ...
                PSEUDO: function (t) {
                  ...
                  return pt.CHILD.test(t[0])
                    ? null
                    : (t[3] ? (t[2] = t[4] || t[5] || "") : n && ut.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && ((t[0] = t[0].slice(0, e)), (t[2] = n.slice(0, e))), t.slice(0, 3));
                },
              },
              filter: {
                TAG: function (t) {
                    ...
                    : function (e, n, l) {
                        ...
                        if (m) {
                          ...
                          if (((h = [s ? m.firstChild : m.lastChild]), s && y)) {
                            for (
                              f = m, p = f[H] || (f[H] = {}), c = p[f.uniqueID] || (p[f.uniqueID] = {}), u = c[t] || [], d = u[0] === M && u[1], b = d && u[2], f = d && m.childNodes[d];
                            ...
                            for (
                              ;
                              (f = (++d && f && f[g]) || (b = d = 0) || h.pop()) &&
                              ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((p = f[H] || (f[H] = {})), (c = p[f.uniqueID] || (p[f.uniqueID] = {})), (c[t] = [M, b])), f !== e));
          ...
          (k = e.tokenize =
            function (t, n) {
              ...
              for (a = t, l = [], u = w.preFilter; a; ) {
                ...
                for (s in w.filter) !(o = pt[s].exec(a)) || (u[s] && !(o = u[s](o))) || ((i = o.shift()), r.push({ value: i, type: s, matches: o }), (a = a.slice(i.length)));
                if (!i) break;
              }
                        ...
                        u = function () {
                          ...
                          if (!(t < s)) {
                            ...
                            (u = n && ("object" == typeof n || "function" == typeof n) && n.then),
                              yt.isFunction(u) ? (o ? u.call(n, r(s, e, f, o), r(s, e, d, o)) : (s++, u.call(n, r(s, e, f, o), r(s, e, d, o), r(s, e, f, e.notifyWith)))) : (i !== f && ((a = void 0), (l = [n])), (o || e.resolveWith)(a, l));
                          }
                        },
                        c = o
                          ? u
      ...
      (yt.fn.ready = function (t) {
        ...
        "complete" === st.readyState || ("loading" !== st.readyState && !st.documentElement.doScroll) ? n.setTimeout(yt.ready) : (st.addEventListener("DOMContentLoaded", g), n.addEventListener("load", g));
            ...
            for (
              ...
              (a = ne.exec(e[u]) || []),
                ...
                d &&
                  ...
                  (p = yt.event.special[d] || {}),
                  (c = yt.extend({ type: d, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && yt.expr.match.needsContext.test(o), namespace: h.join(".") }, r)),
                  (f = l[d]) || ((f = l[d] = []), (f.delegateCount = 0), (p.setup && !1 !== p.setup.call(t, i, h, s)) || (t.addEventListener && t.addEventListener(d, s))),
                ...
                for (p = yt.event.special[d] || {}, d = (i ? p.delegateType : p.bindType) || d, f = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--; )
                  (c = f[r]),
                    (!o && g !== c.origType) ||
                      ...
                      (f.splice(r, 1), c.selector && f.delegateCount--, p.remove && p.remove.call(t, c));
            ...
            for (s = yt.event.handlers.call(this, a, u), e = 0; (o = s[e++]) && !a.isPropagationStopped(); )
              for (a.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                (a.rnamespace && !a.rnamespace.test(r.namespace)) ||
                  ((a.handleObj = r), (a.data = r.data), void 0 !== (i = ((yt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
      ...
      yt.extend({
        ...
        clone: function (t, e, n) {
          ...
          if (e)
            if (n) for (r = r || T(t), s = s || T(a), i = 0, o = r.length; i < o; i++) O(r[i], s[i]);
            else O(t, a);
      ...
      yt.extend({
        ...
        style: function (t, e, n, i) {
          if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
            ...
            (r = typeof n),
              "string" === r && (o = _t.exec(n)) && o[1] && ((n = b(t, e, o)), (r = "number")),
              null != n &&
                n === n &&
                ("number" === r && (n += (o && o[3]) || (yt.cssNumber[a] ? "" : "px")),
          ...
          attr: function (t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
              return void 0 === t.getAttribute
                ? yt.prop(t, e, n)
                : ((1 === r && yt.isXMLDoc(t)) || (o = yt.attrHooks[e.toLowerCase()] || (yt.expr.match.bool.test(e) ? we : void 0)),
                  void 0 !== n
                    ? null === n
      ...
      yt.fn.extend({
        ...
        yt.extend({
          prop: function (t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
              return (
                (1 === r && yt.isXMLDoc(t)) || ((e = yt.propFix[e] || e), (o = yt.propHooks[e])),
        ...
        yt.fn.extend({
          ...
          toggleClass: function (t, e) {
            ...
            return "boolean" == typeof e && "string" === n
              ...
              : this.each(function () {
                  var e, i, o, r;
                  if ("string" === n) for (i = 0, o = yt(this), r = t.match(It) || []; (e = r[i++]); ) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
          ...
          if (
            ...
            for (r = 0; (s = f[r++]) && !t.isPropagationStopped(); )
              (t.type = r > 1 ? l : p.bindType || d),
                ...
                c && c.apply(s, e),
                (c = u && s[u]) && c.apply && Rt(s) && ((t.result = c.apply(s, e)), !1 === t.result && t.preventDefault());
            return (
              (t.type = d),
              o ||
                ...
                !Rt(i) ||
                (u && yt.isFunction(i[d]) && !yt.isWindow(i) && ((a = i[u]), a && (i[u] = null), (yt.event.triggered = d), i[d](), (yt.event.triggered = void 0), a && (i[u] = a))),
              t.result
            );
          }
        },
          ...
          ajax: function (t, e) {
            function i(t, e, i, a) {
              ...
              c ||
                ...
                (x = ot(h, x, C, u)),
                u
                  ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")), w && (yt.lastModified[r] = w), (w = C.getResponseHeader("etag")) && (yt.etag[r] = w)),
                    204 === t || "HEAD" === h.type ? (T = "nocontent") : 304 === t ? (T = "notmodified") : ((T = x.state), (f = x.data), (d = x.error), (u = !d)))
                ...
                y.fireWith(g, [C, T]),
                p && (m.trigger("ajaxComplete", [C, h]), --yt.active || yt.event.trigger("ajaxStop")));
            }
            ...
            (p = yt.event && h.global),
              ...
              (r = h.url.replace(Le, "")),
              h.hasContent
                ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Pe, "+"))
                : ((d = h.url.slice(r.length)), h.data && ((r += (Ne.test(r) ? "&" : "?") + h.data), delete h.data), !1 === h.cache && ((r = r.replace(qe, "$1")), (d = (Ne.test(r) ? "&" : "?") + "_=" + De++ + d)), (h.url = r + d)),
              h.ifModified && (yt.lastModified[r] && C.setRequestHeader("If-Modified-Since", yt.lastModified[r]), yt.etag[r] && C.setRequestHeader("If-None-Match", yt.etag[r])),
                  ...
                  return function () {
                    e &&
                      ...
                      "abort" === t
                        ...
                        : r(ze[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                  };
                }),
                  (a.onload = e()),
                  (i = a.onerror = e("error")),
      ...
      yt.ajaxSetup({
        ...
        (yt.parseHTML = function (t, e, n) {
          ...
          var i, o, r;
          return (
            e || (vt.createHTMLDocument ? ((e = st.implementation.createHTMLDocument("")), (i = e.createElement("base")), (i.href = st.location.href), e.head.appendChild(i)) : (e = st)),
            (o = $t.exec(t)),
            (r = !n && []),
            o ? [e.createElement(o[1])] : ((o = k([t], e, r)), r && r.length && yt(r).remove(), yt.merge([], o.childNodes))
          );
        }),
        ...
        (yt.offset = {
          setOffset: function (t, e, n) {
            ...
            "static" === c && (t.style.position = "relative"),
              ...
              u ? ((i = p.position()), (s = i.top), (o = i.left)) : ((s = parseFloat(r) || 0), (o = parseFloat(l) || 0)),
          ...
          offset: function (t) {
            ...
            if (r)
              return r.getClientRects().length
                ? ((i = r.getBoundingClientRect()), (e = r.ownerDocument), (n = e.documentElement), (o = e.defaultView), { top: i.top + o.pageYOffset - n.clientTop, left: i.left + o.pageXOffset - n.clientLeft })
                : { top: 0, left: 0 };
          },
          position: function () {
            if (this[0]) {
              ...
              return (
                "fixed" === yt.css(n, "position")
                  ...
                  : ((t = this.offsetParent()), (e = this.offset()), l(t[0], "html") || (i = t.offset()), (i = { top: i.top + yt.css(t[0], "borderTopWidth", !0), left: i.left + yt.css(t[0], "borderLeftWidth", !0) })),
                    ...
                    value: function (t, e) {
                      ...
                      this.timeout = setTimeout(function () {
                        ...
                        e > n.stopNum
                          ? (e--, n.backspace(t, e))
                          : e <= n.stopNum &&
                            (n.arrayPos++, n.arrayPos === n.strings.length ? ((n.arrayPos = 0), n.options.onLastStringBackspaced(), n.shuffleStringsIfNeeded(), n.begin()) : n.typewrite(n.strings[n.sequence[n.arrayPos]], e));
                      }, i);
                    },
                  },
                  {
                ...
                t.support.transition && this.$element.hasClass("slide")
                  ? (r.addClass(e),
                    ...
                    o
                      ...
                      .emulateTransitionEnd(n.TRANSITION_DURATION))
                  : (o.removeClass("active"), r.addClass("active"), (this.sliding = !1), this.$element.trigger(f)),
                s && this.cycle(),
                this
              );
            }
